// Teste simples do calendário corrigido
const { PrismaClient } = require('@prisma/client');

const prisma = new PrismaClient();

async function testSimpleCalendar() {
  console.log('🧪 Teste Simples do Calendário Corrigido\n');
  ...
  try {
    ...
    console.log(`   LIVRE: 13:30+ (aeronave liberada)`);
    ...
    console.log(`   Próxima missão possível: 13:30+ (precisa de 3h livres antes)`);
    
    console.log('\n🎨 Cores no Frontend:');
    console.log(`   🟢 Verde: Disponível`);
    console.log(`   ⚫ Cinza: Missão em andamento`);
    console.log(`   🟡 Amarelo: Pré-voo (-3h)`);
...
testSimpleCalendar().catch(console.error);
