// Teste FINAL para verificar se a correção real funcionou
console.log('🧪 TESTE FINAL - CORREÇÃO REAL');
console.log('==============================');
...
// Simular janelaBloqueada CORRETO (FINAL)
console.log('\n🔍 janelaBloqueada (CORRETO - FINAL):');
...
console.log('   ✅ bookingToMissao inclui actualDeparture e actualReturn');
