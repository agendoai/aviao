...
async function testPosVooFix() {
  try {
    ...
    // 2. Criar uma missão que termina às 20:30
    ...
    const mission = await prisma.booking.create({
      data: {
        ...
        origin: 'SBAU',
        destination: 'SBSP',
        departure_date: new Date('2025-09-15T07:00:00Z'), // 07:00
        return_date: new Date('2025-09-15T20:30:00Z'), // 20:30  
        passengers: 2,
    ...
    for (const slot of testSlots) {
      ...
      const slotDateTime = new Date('2025-09-15T00:00:00Z');
